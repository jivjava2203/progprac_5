...
import ReaderWriter.TeacherAssignmentRW;
 ...
 * @author admin
 */
public class EnrollmentSubject extends javax.swing.JFrame {
    ...
    public EnrollmentSubject(SubjectCRUD sblist, TeacherAssignmentCRUD tslist, TeacherAssignmentRW tsru, Teacher teacher) {
        this.sblist = sblist;
        this.tslist = tslist;
        this.tsru = tsru;
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Enrolled Subjects");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Subject subject = sblist.subjectlist.get(modelIndex);

        TeacherAssignment ta = new TeacherAssignment (teacher, subject);
        tslist.createAssignment(ta);
        tsru.write(tslist);
        this.dispose();
