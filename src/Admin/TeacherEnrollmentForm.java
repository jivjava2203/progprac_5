 ...
 * @author admin
 */
public class TeacherEnrollmentForm extends javax.swing.JFrame {
    ...
    int counter;
    public TeacherEnrollmentForm(TeacherCRUD tlist, TeacherRW teacherru) {
    ...
    TeacherEnrollmentForm(TeacherCRUD tlist, TeacherRW teacherru, Teacher oldTeacher) {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Create Teacher");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(counter == 1){
            tlist.teacherCreate(newteacher);
            teacherru.write(tlist);
        }
        tlist.teacherUpdate(teacher, newteacher);
        teacherru.write(tlist);
        this.dispose();
